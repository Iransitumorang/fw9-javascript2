// 1.reduce() = menyatukan dengan cara menjumlahkan seluruh nilai di array
function useReduce() {
...
// 2.join() =  untuk menggabungkan nilai array menjadi sebuah string.
function useJoin(){
...
console.log(useJoin()); // Output : Jakarta, Medan, Manado, Bandung
console.log(
    "================================================"
);

// 3. slice() = Menghapus array dengan dengan lenght yg kita inginkan
function useSlice() {
...
useSlice(); // Output: [ 'James K', 'JK Rowling' ]
console.log(
    "================================================"
);

// 4. splice() = memotong array dan atau menambahkan elemen array sekaligus
function useSplice() {
...
console.log(useSplice()); // [ 'Indonesia', 'Singpore', 'South Korea', 'China', 'Japan' ]
console.log(
    "================================================"
);
...
console.log(usePop()); // Output : [ 'Lexus', 'Mazda', 'Hyundai' ]
console.log(
    "================================================"
);

// 6. shift() = menghapus elemen paling awal array dan menggeser ke bawah seluruh elemen setelahnya
function useShift() {
...
console.log(useShift()); // Output : Yang di hapus :  Samsung
// [ 'Iphone', 'Google', 'Oneplus' ]
console.log(
    "================================================"
);
...
console.log(useUnShift()); // Output: [ 'Papua', 'Kalimantan', 'Sumatera', 'Jawa', 'Sulawesi' ]
console.log(
    "================================================"
);

// 8. some() =  untuk mengecek minimal salah satu elemen array memenuhi kondisi.
function useSome() {
...
// 9. every() = untuk mengecek apakah semua elemen memenuhi kondisi.
function useEvery() {
...
// 10. reverse() = membalikkan urutan elemen di dalam array misal 1,2,3 menjadi 3,2,1.
function useReverse() {
